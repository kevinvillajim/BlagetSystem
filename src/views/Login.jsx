	...
	return (
		<div className="flex flex-row w-[100%] h-screen items-center">
			<div className="w-[65%] bg-gradient-to-r from-gray-500 to-gray-100/50 h-screen flex items-center">
				...
				></video>
				<a href="/home">
					<div className="absolute top-0 left-0 w-[10rem] bg-white/70 p-[2rem] rounded-lg shadow-md shadow-black">
						<div>
							<img src="logo.png" className="w-[8rem]" />
						</div>
					</div>
				</a>
			...
			<div className="w-[35%] flex items-center bg-gray-100 h-screen">
				<div className="login ">
					<div className="p-[2rem] m-[2rem] border border-gray-300 rounded-lg bg-white">
						...
						<form method="post">
							...
							<button className="w-[100%] p-[0.5rem] px-[1.5rem] bg-[black] rounded-full text-[white] cursor-pointer transition duration-300 ease-in-out relative overflow-hidden botonAnim my-[1rem]">
