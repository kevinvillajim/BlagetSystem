...
function CourseCard({title, img, description, progress, link, course}) {
	return (
		<>
			<div className="flex flex-col border-b-2 border-[#22c55e] bg-[#eaeaea] rounded-md pb-[1rem]">
                ...
                <MoreVertIcon color="success" />
					...
					<div className="">
						<ProgressBar totalValue={progress} text="black" />
					</div>
					{progress === 100 ? (
						<>
							...
							{localStorage.setItem(`Course${course}isFinished`, "true")}
						</>
					) : (
						""
					)}
