...
const Tabs = ({tabs}) => {
	...
	return (
		<div className="flex justify-center my-[3rem]">
			<div className="p-4 w-full max-w-4xl min-w-sm flex bg-gray-300 rounded-lg shadow-lg items-center">
				<ul className="flex flex-col border-r border-gray-200 pr-4 gap-5">
					{tabs.map((tab) => (
						<li key={tab.id}>
							<button
				...
				<div className="pl-4 w-full h-[33rem] overflow-hidden flex items-center">
					{tabs.map((tab) => (
						<div
							key={tab.id}
